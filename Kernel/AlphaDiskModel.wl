...
DiskParams::usage = "DiskParams[a, \[Alpha], m, mdot, Options] returns an association containing information about accretion disk's radiation. The keys are 'Temperature', 'SpectralFluxDensity' and 'FluxDensity'.";
